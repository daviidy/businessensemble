    ...
    a.SmallMap = a.Class({
        ...
        init: function(C, B) {
            ...
            if (A.enabled) {
                ...
                y.push(v);
                v.toBack();
                var u, s, v = A.minimizeButtonWidth,
        ...
        update: function() {
            ...
            if (!(0 < this.delayCounter)) {
                if (this.frame <= e) {
                    ...
                    e = f(0, this.frame, 0, 1, e); - 1 == this.direction && (e = 1 - e);

        <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <label for="">Rôle idéal de l'investisseu</label>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <label for="fname">Avez-vous déjà réalisé une levée de fond ? </label>
                            <input type="Number" name="title" placeholder="Si oui combien ?" />
                        </div>
                        <div class="col-md-6 col-sm-12">

...
.backnow-login-register a.backnow-dashboard:hover{background:#00bf9c;}
...
.backnow-login-register a.backnow-dashboard{background-color:#33d3c0;}
                            ...
                            <ul id="menu-main-menu" class="nav">
                                <li class=" menu-item menu-item-type-custom menu-item-object-custom menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children active has-menu-child"><a
                                    ...
                                    <ul role="menu" class="sub-menu">
                                        <li class=" menu-item menu-item-type-post_type menu-item-object-page has-menu-child"><a href="https://demo.themeum.com/wordpress/backnow/homepage-2/">Homepage 2</a></li>
                                        <li class=" menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1953 current_page_item active has-menu-child"><a
                                              href="https://demo.themeum.com/wordpress/backnow/homepage-3/">Homepage 3</a></li>
                                    </ul>
                                </li>
                        ...
                        <div class="themeum-navbar-header">
                            <div class="logo-wrapper">
                                <a class="themeum-navbar-brand" href="https://demo.themeum.com/wordpress/backnow">
                                    <img class="enter-logo img-responsive" src="http://demo.themeum.com/wordpress/backnow/wp-content/uploads/2018/01/logo.png" alt="Logo" title="Logo">
                                </a>
                            </div>
                        </div>
                                ...
                                <ul id="menu-main-menu-1" class="nav navbar-nav">
                                    <li id="menu-item-27" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children menu-item-27 active"><a title="Home"
                                        ...
                                        <ul role="menu" class="collapse collapse-27 ">
                                            ...
                                            <li id="menu-item-1956" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1953 current_page_item menu-item-1956 active"><a title="Homepage 3"
                                                  href="https://demo.themeum.com/wordpress/backnow/homepage-3/">Homepage 3</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="menu-item-1823" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1823"><a title="Discover" href="https://demo.themeum.com/wordpress/backnow/discover/">Discover</a>
                                        ...
                                        <ul role="menu" class="collapse collapse-1823 ">
                                            <li id="menu-item-1822" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1822"><a title="Discover Style 2" href="https://demo.themeum.com/wordpress/backnow/discover-style-2/">Discover Style
                                                    2</a></li>
                                        </ul>
                                    </li>
                                </ul>

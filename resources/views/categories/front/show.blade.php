...
@media all{
.subtitle-cover{position:relative;z-index:1;}
.subtitle-cover::before{content:'';position:absolute;height:100%;width:100%;z-index:-1;top:0;left:0;opacity:.95;}
.subtitle-cover h2{padding-top:10px;text-transform:capitalize;font-weight:normal;line-height:65px;}
.subtitle-cover.sub-title p{font-size:16px;line-height:30px;color:#fff;margin-top:8px;font-weight:100;}
}
/*! CSS Used from: https://demo.themeum.com/wordpress/backnow/wp-content/themes/backnow/css/custom.css?ver=all ; media=all */
@media all{
span.backnow-icons{font-size:44px;color:#fff;}
}
/*! CSS Used from: Embedded */
.subtitle-cover::before{background:#{{$category->icon_color}};}
h2{font-size:36px;font-family:Montserrat;font-weight:400;line-height:42px;color:#414040;}
.wrappers-content .subtitle-cover::before{background:#{{$category->icon_color}};}
.subtitle-cover h2{font-size:48px;color:#ffffff;}
.subtitle-cover{background:#{{$category->icon_color}};padding:65px 65px;margin-bottom:88px;}
...
<div class="subtitle-cover sub-title" style="background-image:url(http://demo.themeum.com/wordpress/backnow/wp-content/uploads/2018/01/banner.jpg);background-size: cover;background-position: 50% 50%;">
    <div class="container">
        <div class="row">
